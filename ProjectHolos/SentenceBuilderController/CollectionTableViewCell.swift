...
class CollectionTableViewCell: UITableViewCell {
    ...
    var collectionFlowLayout: IndexedCollectionViewFlowLayout!
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        collectionFlowLayout = IndexedCollectionViewFlowLayout()
        collectionFlowLayout.scrollDirection = .horizontal
        
        collectionView = IndexedCollectionView(frame: .zero, collectionViewLayout: collectionFlowLayout)
